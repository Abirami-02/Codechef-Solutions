...
public class Codechef {
    ...
    public static int checkAnswer(String userAnswer, String correctAnswer) {
        ...
        if (userAnswer != null && userAnswer.equals(correctAnswer)) { // Check if the userAnswer is equal to correct answer
    ...
    public static int updateScore(int score, int result) {
        ...
        // if the result is 1 add to the score and return it, else return the score as it is
        if (result == 1) {
        score = score + 1;
    }
